...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center px-30 py-20 relative overflow-hidden pt-16">
      {/* Dynamic Background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          {/* Left Content */}
          <div className={`order-2 lg:order-1 lg:col-span-7 space-y-8 transition-all duration-1000 ${
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl sm:text-2xl md:text-3xl text-slate-300 font-light leading-relaxed">
                  <span className="font-medium bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent font-medium">Software Engineer</span> 
                </p>
                
                <p className="text-slate-400 leading-relaxed max-w-xl text-lg font-light">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <a 
                    key={index}
                    href={href} 
                    className="group relative p-3 bg-slate-800/30 backdrop-blur-sm border border-slate-700/30 rounded-xl hover:bg-slate-700/50 hover:border-cyan-400/50 transition-all duration-300 hover:scale-110"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={label}
                  >
                    <Icon size={20} className="text-slate-400 group-hover:text-cyan-400 transition-colors" />
                    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-slate-800 text-xs text-slate-300 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                      {label}
                    </div>
                  </a>
                ))}
...
<div className={`order-1 lg:order-2 lg:col-span-5 relative transition-all duration-1000 delay-300 ${
            ...
            <div className="relative mx-auto max-w-[18rem] lg:max-w-xs xl:max-w-sm">
              ...
              <div className="absolute inset-0 animate-spin-slow">
                <div className="absolute top-0 left-0 w-full h-full border-2 border-dashed border-cyan-500/30 rounded-full"></div>
              </div>
              <div className="absolute inset-4 animate-reverse-spin-slow">
                <div className="absolute top-0 left-0 w-full h-full border border-dashed border-purple-500/30 rounded-full"></div>
              </div>
              ...
              {/* Floating Tech Icons */}
              <div className="absolute -top-6 -right-6 w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center shadow-lg animate-float">
                <span className="text-white font-bold text-lg">⚡</span>
              </div>
              
              <div className="absolute top-1/2 -left-8 w-14 h-14 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg animate-float-delay">
                <span className="text-white font-bold text-xl">🚀</span>
              </div>
              
              <div className="absolute -bottom-4 right-8 w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg animate-float-slow">
                <span className="text-white font-bold">✨</span>
              </div>
              
              {/* Status Badge */}
              <div className="absolute -bottom-8 -left-8 px-6 py-3 bg-slate-900/90 backdrop-blur-sm border border-cyan-500/30 rounded-2xl shadow-xl">
                <div className="flex items-center gap-3">
      ...
      <style jsx>{`
        ...
        .bg-grid-white\\/\\[0\\.02\\] {
          background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32' fill='none' stroke='rgb(255 255 255 / 0.02)'%3e%3cpath d='m0 .5h32m0 15.5h-32m32-14.5v32m-32-32v32'/%3e%3c/svg%3e");
        }
      `}</style>
    </section>
  );

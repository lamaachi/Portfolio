        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 text-lg md:text-xl text-gray-300 leading-relaxed">
            <p className="p-4 bg-gray-800 rounded-lg shadow-xl border border-gray-700 hover:border-purple-500 transition-all duration-300">
              Hello! I'm a passionate <strong className="font-semibold text-purple-400">Full-Stack Software Engineer</strong> with a knack for building robust and scalable web applications. I thrive on solving complex problems and continuously learning new technologies.
            </p>
            <p className="p-4 bg-gray-800 rounded-lg shadow-xl border border-gray-700 hover:border-purple-500 transition-all duration-300">
            ...
            <p className="p-4 bg-gray-800 rounded-lg shadow-xl border border-gray-700 hover:border-purple-500 transition-all duration-300">
              When I'm not coding, you can find me exploring new tech gadgets or enjoying a good book. I believe in clean code, elegant solutions, and user-centric design.
            </p>
          </div>
